...
# - GLOBAL VARIABLES
from data_collector.module_company import Company
from data_collector.module_neo4j import create_company_node, create_officer_node, create_relationship
from data_collector.module_officer import Officer
...
def get_company_neighbourhood(company_id):
    ...
    try:
        # MAKE CALL
        response = requests.get(url=call, auth=HTTPBasicAuth('3oYfAJNSaKgrxgG0RPcpxIPe6J7p2n3EHYJfyJvg', ''))
...
if __name__ == "__main__":
    ...
    first_company_id = input("Please provide company_id (e.g. Reply Ltd = 03847202 or "
                                 "Vodafone Ltd = 01471587): ")

    # GET NEIGHBOURHOOD HOP RADIUS
    max_hops = int(input("Maximum number of hops away from company: "))
